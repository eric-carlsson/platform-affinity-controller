module github.com/eric-carlsson/platform-affinity-controller
...
require (
	...
	github.com/google/go-containerregistry/pkg/authn/kubernetes v0.0.0-20260911193048-0c8bedb78437 // indirect
