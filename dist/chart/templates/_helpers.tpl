...
*/}}
{{- define "platform-affinity-controller.name" -}}
...
*/}}
{{- define "platform-affinity-controller.fullname" -}}
...
*/}}
{{- define "platform-affinity-controller.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "platform-affinity-controller.resourceName" -}}
{{- $fullname := include "platform-affinity-controller.fullname" .context }}
{{- $suffix := .suffix }}
